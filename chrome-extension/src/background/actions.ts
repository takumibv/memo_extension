...
} from '@extension/shared/lib/storages/defaultColorStorage';
import {
  ...
  getAllNotesByPageId,
  getAllNotes,
} from '@extension/shared/lib/storages/noteStorage';
import {
  getIsVisibleNote as _getIsVisibleNote,
  setIsVisibleNote as _setIsVisibleNote,
} from '@extension/shared/lib/storages/noteVisibleStorage';
import {
  getAllPageInfos,
  ...
  getPageInfoByUrl,
} from '@extension/shared/lib/storages/pageInfoStorage';
