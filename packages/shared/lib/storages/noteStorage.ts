import { getAllStorage, getNewId, getStorage, removeStorage, setStorage } from './common.js';
import { deletePageInfo } from './pageInfoStorage.js';
...
export const getNotesByPageId = async (): Promise<Note[]> =>
  // TODO: implement this function with pageId parameter
  new Promise((_resolve, reject) => reject('getAllNotes is not implemented'));
