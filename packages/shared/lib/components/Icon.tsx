...
export const LogoIcon: FC<React.SVGProps<SVGSVGElement>> = props => (
  <svg xmlns="http://www.w3.org/2000/svg" width="133" height="129" viewBox="0 0 132.649 129" {...props}>
    ...
    <g id="icon_128" transform="translate(-1824 -1067)">
      ...
      <path id="p-2" data-name="p" d="M4,4V95H95V4H4M0,0H99V99H0Z" transform="translate(1824 1097)" fill="#707070" />
      ...
      <path
        ...
        fill="#707070"
      />
      <rect id="r-2" data-name="r" width="63" height="5" transform="translate(1842 1132.89)" fill="#dfce11" />
      <rect id="r-3" data-name="r" width="63" height="5" transform="translate(1842 1150.323)" fill="#dfce11" />
      <rect id="r-4" data-name="r" width="63" height="5" transform="translate(1842 1167.756)" fill="#dfce11" />
    </g>
  </svg>
);
